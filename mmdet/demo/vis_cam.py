...
from det_cam_visualizer import (DetAblationLayer, DetBoxScoreTarget, DetCAMModel,DetCAMVisualizer, FeatmapAM, reshape_transform)
...
"""
python /remote-home/liguopeng/object_detection/object_detection/mmdetection/demo/vis_cam.py /remote-home/liguopeng/object_detection/object_detection/mmdetection/datasets/coco/val2017/000000060855.jpg /remote-home/liguopeng/object_detection/object_detection/mmdetection/configs/faster_rcnn/faster_rcnn_r50_fpn_1x_coco.py /remote-home/liguopeng/object_detection/object_detection/mmdetection/checkpoints/faster_rcnn_r50_fpn_1x_coco_20200130-047c8118.pth --method ablationcam --out-dir save_dir
"""
def parse_args():
