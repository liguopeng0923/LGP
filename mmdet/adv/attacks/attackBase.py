...
from ..builder import ATTACK_METHODS
...
class attackBase(nn.Module):
    ...
    def __init__(self,
        ...
        Args:
            ...
            adv_labels (int, optional): The labels of target adversarial examples. Defaults to None.
    ...
    def _select_bboxes_iou_single(
        ...
        iou_bboxes = bbox_overlaps(target_bboxes,predict_bboxes,mode = "iou")
    ...
    def _select_bboxes_score_single(
        ...
        iou_bboxes = bbox_overlaps(foreground_bboxes,target_bboxes,mode = "iou")
